...
import { of } from 'rxjs';
import { DetalharMensagensComponent } from './detalhar-mensagens.component';
import { CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';


describe('DetalharMensagensComponent', () => {
  let component: DetalharMensagensComponent;
  let fixture: ComponentFixture<DetalharMensagensComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [DetalharMensagensComponent],
      providers: [
        FormBuilder,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DetalharMensagensComponent);
