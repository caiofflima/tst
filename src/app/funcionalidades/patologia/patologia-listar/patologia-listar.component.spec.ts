...
import { PatologiaListarComponent } from './patologia-listar.component';


describe('PatologiaListarComponent', () => {
  let component: PatologiaListarComponent;
  let fixture: ComponentFixture<PatologiaListarComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [PatologiaListarComponent],
      providers: [
        FormBuilder,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PatologiaListarComponent);
