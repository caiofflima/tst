...
import { PatologiaFormComponent } from './patologia-form.component';


describe('PatologiaFormComponent', () => {
  let component: PatologiaFormComponent;
  let fixture: ComponentFixture<PatologiaFormComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [PatologiaFormComponent],
      providers: [
        FormBuilder,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PatologiaFormComponent);
