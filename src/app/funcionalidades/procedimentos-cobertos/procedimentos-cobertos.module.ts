...
@NgModule({
    imports: [
        CommonModule,
        ProcedimentosCobertosRoutingModule,
    ...
    declarations: [
        ...
        ProcedimentosCobertosResultComponent,
        ListarProcedimentosComReembolsoComponent
    ] ,
    schemas: [
...
export class ProcedimentosCobertosModule {
}
