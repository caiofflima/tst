...
import { RelatorioProcedimentosSolicitadosPorProfissionalListarComponent } from './procedimentos-solicitados-por-profissional-listar.component';

describe('RelatorioProcedimentosSolicitadosPorProfissionalListarComponent', () => {
  let component: RelatorioProcedimentosSolicitadosPorProfissionalListarComponent;
  let fixture: ComponentFixture<RelatorioProcedimentosSolicitadosPorProfissionalListarComponent>;
  ...
  const prestadorExternoServiceSpy = jasmine.createSpyObj('PrestadorExternoService',['consultarPorFiltro']);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [RelatorioProcedimentosSolicitadosPorProfissionalListarComponent,
        CampoVazioHifen,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RelatorioProcedimentosSolicitadosPorProfissionalListarComponent);
