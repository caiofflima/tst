...
import { RelatorioJuntaMedicaOdontologicaListarComponent } from './junta-medica-odontologica-listar.component';

describe('RelatorioJuntaMedicaOdontologicaListarComponent', () => {
  let component: RelatorioJuntaMedicaOdontologicaListarComponent;
  let fixture: ComponentFixture<RelatorioJuntaMedicaOdontologicaListarComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [RelatorioJuntaMedicaOdontologicaListarComponent,
        CampoVazioHifen,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RelatorioJuntaMedicaOdontologicaListarComponent);
