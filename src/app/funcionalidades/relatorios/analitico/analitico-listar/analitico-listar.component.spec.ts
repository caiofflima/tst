...
import { RelatorioAnaliticoListarComponent } from './analitico-listar.component';

describe('RelatorioAnaliticoListarComponent', () => {
  let component: RelatorioAnaliticoListarComponent;
  let fixture: ComponentFixture<RelatorioAnaliticoListarComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [RelatorioAnaliticoListarComponent,
        CampoVazioHifen,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RelatorioAnaliticoListarComponent);
