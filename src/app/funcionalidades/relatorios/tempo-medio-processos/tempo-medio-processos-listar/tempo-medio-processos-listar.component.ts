...
@Component({
    selector: 'app-tempo-medio-processos-listar',
    templateUrl: 'tempo-medio-processos-listar.component.html',
    styleUrls: ['tempo-medio-processos-listar.component.scss']
})
export class RelatorioTempoMedioProcessosListarComponent extends BaseComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.atualizarMensagemPaginacao(end);
    }

    private atualizarMensagemPaginacao(end: number) {
    ...
    exportarPDFRelatorioTempoMedioProcessos() {
        this.processoService.exportarPDFRelatorioTempoMedioProcessos(this.listaProcessos).subscribe((fileByteArray: any) => {
            ...
            a.download = 'relatorio-tempo-medio-processos.pdf';
    ...
    exportarXLSRelatorioTempoMedioProcessos() {
        this.processoService.exportarXLSRelatorioTempoMedioProcessos(this.listaProcessos).subscribe((fileByteArray: any) => {
            ...
            a.href = window.URL.createObjectURL(blob);
            a.download = 'relatorio-tempo-medio-processos.xls';
    ...
    exportarCSVRelatorioTempoMedioProcessos() {
        this.processoService.exportarCSVRelatorioTempoMedioProcessos(this.listaProcessos).subscribe((fileByteArray: any) => {
            ...
            a.href = window.URL.createObjectURL(blob);
            a.download = 'relatorio-tempo-medio-processos.csv';
    ...
    retornarConsulta() {
        this.router.navigateByUrl('/relatorios/tempo-medio-processos');
    }
    ...
    consultarRelatorioAnalitico() {
        ...
        if (this.listaProcessos.length > 0) {
            let filtroRelatorioOrigem: FiltroRelatorioTempoMedioProcessos = this.data.storage.filtro;
            ...
            filtroRelAnalitico.relatorioOrigem = "TEMPO_MEDIO_PROCESSOS";

            this.processoService.consultarRelatorioAnaliticoTempoMedioProcessos(filtroRelAnalitico).subscribe(res => {
                const voltar = '/relatorios/tempo-medio-pedidos';
                this.data.storage = {
                    pageable: res,
