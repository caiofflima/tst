...
import { RelatorioTempoMedioProcessosListarComponent } from './tempo-medio-processos-listar.component';

describe('RelatorioTempoMedioProcessosListarComponent', () => {
  let component: RelatorioTempoMedioProcessosListarComponent;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [RelatorioTempoMedioProcessosListarComponent,
        CampoVazioHifen,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RelatorioTempoMedioProcessosListarComponent);
