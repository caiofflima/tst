...
import { RelatorioControlePrazosProcessosListarComponent } from './controle-prazos-processos-listar.component';

describe('RelatorioControlePrazosProcessosListarComponent', () => {
  let component: RelatorioControlePrazosProcessosListarComponent;
  let fixture: ComponentFixture<RelatorioControlePrazosProcessosListarComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [RelatorioControlePrazosProcessosListarComponent,
        CampoVazioHifen,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RelatorioControlePrazosProcessosListarComponent);
