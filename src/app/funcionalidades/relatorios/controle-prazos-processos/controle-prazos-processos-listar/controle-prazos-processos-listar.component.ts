import {FiltroRelatorioControlePrazosProcessos} from 'app/shared/models/filtro/filtro-relatorio-controle-prazos-processos';
...
@Component({
    selector: 'app-controle-prazos-processos-listar',
    templateUrl: 'controle-prazos-processos-listar.component.html',
    styleUrls: ['controle-prazos-processos-listar.component.scss']
})
export class RelatorioControlePrazosProcessosListarComponent extends BaseComponent implements OnInit {
    ...
    constructor(
        ...
        this.filtro = new FiltroRelatorioControlePrazosProcessos()
    ...
    exportarPDFRelatorioControlePrazosProcessos() {
        this.processoService.exportarPDFRelatorioControlePrazosProcessos(this.listaProcessos).subscribe((fileByteArray: any) => {
            ...
            a.download = 'relatorio-controle-prazos-pedidos.pdf';
    ...
    exportarXLSRelatorioControlePrazosProcessos() {
        this.processoService.exportarXLSRelatorioControlePrazosProcessos(this.listaProcessos).subscribe((fileByteArray: any) => {
            ...
            a.href = window.URL.createObjectURL(blob);
            a.download = 'relatorio-controle-prazos-pedidos.xls';
    ...
    exportarCSVRelatorioControlePrazosProcessos() {
        console.log('this.listaProcessos', this.listaProcessos)
        this.processoService.exportarCSVRelatorioControlePrazosProcessos(this.listaProcessos).subscribe((fileByteArray: any) => {
            ...
            a.href = window.URL.createObjectURL(blob);
            a.download = 'relatorio-controle-prazos-pedidos.csv';
    ...
    retornarConsulta() {
        this.router.navigateByUrl('/relatorios/controle-prazos-pedidos');
    }
    ...
    consultarRelatorioAnalitico() {
        ...
        if (this.listaProcessos.length > 0) {
            let filtroRelatorioOrigem: FiltroRelatorioControlePrazosProcessos = this.data.storage.filtro;
            ...
            filtroRelAnalitico.relatorioOrigem = "CONTROLE_PRAZOS_PROCESSOS";

            this.processoService.consultarRelatorioAnaliticoControlePrazosProcessos(filtroRelAnalitico).subscribe(res => {
                const voltar = '/relatorios/controle-prazos-pedidos';
                this.data.storage = {
                    pageable: res,
