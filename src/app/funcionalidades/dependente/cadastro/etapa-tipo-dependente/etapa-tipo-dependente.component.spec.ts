...
import { EtapaTipoDependenteComponent } from './etapa-tipo-dependente.component';
import { CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA } from '@angular/core';

describe('EtapaTipoDependenteComponent', () => {
  let component: EtapaTipoDependenteComponent;
  let fixture: ComponentFixture<EtapaTipoDependenteComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [EtapaTipoDependenteComponent, CampoVazioHifen, TelefonePipe],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EtapaTipoDependenteComponent);
