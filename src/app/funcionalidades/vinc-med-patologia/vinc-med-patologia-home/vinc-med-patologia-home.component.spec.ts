...
import { ReembolsoService } from 'app/shared/services/comum/reembolso.service';
import { MedicamentoPatologiaService } from 'app/shared/services/comum/medicamento-patologia.service';
import { VincMedPatologiaHomeComponent } from './vinc-med-patologia-home.component';

describe('VincMedPatologiaHomeComponent', () => {
  let component: VincMedPatologiaHomeComponent;
  let fixture: ComponentFixture<VincMedPatologiaHomeComponent>;
  ...
  const patologiaServiceSpy = jasmine.createSpyObj('PatologiaService',['consultarTodos','consultarDTOPorId']);
  const tipoProcessoServiceSpy = jasmine.createSpyObj('TipoProcessoService',['consultarTiposProcessoAutorizacaoPrevia']);
  ...
  const inscricaoProgramasMedicamentosServiceSpy = jasmine.createSpyObj('InscricaoProgramasMedicamentosService',['get']);
  const localidadeServiceSpy = jasmine.createSpyObj('LocalidadeService',['get']);
  const reembolsoServiceSpy = jasmine.createSpyObj('ReembolsoService',['get']);
  const medicamentoPatologiaServiceSpy = jasmine.createSpyObj('MedicamentoPatologiaService',['get']);
  ...
  patologiaServiceSpy.consultarTodos.and.returnValue(of({}));
  sIASCFluxoServiceSpy.consultarPermissoesFluxoPorPedido.and.returnValue(of({}));
  tipoProcessoServiceSpy.consultarTiposProcessoAutorizacaoPrevia.and.returnValue(of({}));
  medicamentoPatologiaServiceSpy.get.and.returnValue(of({}));
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [VincMedPatologiaHomeComponent,
        CampoVazioHifen,
      ...
      providers: [
        ...
        { provide: InscricaoProgramasMedicamentosService, useValue: inscricaoProgramasMedicamentosServiceSpy },
        { provide: LocalidadeService, useValue: localidadeServiceSpy },
        { provide: ReembolsoService, useValue: reembolsoServiceSpy },
        { provide: MedicamentoPatologiaService, useValue: medicamentoPatologiaServiceSpy },
      ],
      schemas: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(VincMedPatologiaHomeComponent);
