...
describe('VincMedPatologiaHomeComponent', () => {
  ...
  const patologiaServiceSpy = { consultarTodos: jest.fn(), consultarDTOPorId: jest.fn() };
  const tipoProcessoServiceSpy = { consultarTiposProcessoAutorizacaoPrevia: jest.fn() };
  ...
  const medicamentoPatologiaServiceSpy = { get: jest.fn() };
