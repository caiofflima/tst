...
import { EmpresaCredenciadaListarComponent } from './empresa-credenciada-listar.component';

describe('EmpresaCredenciadaListarComponent', () => {
  let component: EmpresaCredenciadaListarComponent;
  ...
  const empresaPrestadorExternoServiceSpy = jasmine.createSpyObj('EmpresaPrestadorExternoService',['consultarEmpresaPorId', 'consultarFiliais','consultarPorFiltro']);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [EmpresaCredenciadaListarComponent],
      providers: [
        FormBuilder,
        Data,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EmpresaCredenciadaListarComponent);
