...
import { EmpresaCredenciadaFormComponent } from './empresa-credenciada-form.component';

describe('EmpresaCredenciadaFormComponent', () => {
  let component: EmpresaCredenciadaFormComponent;
  let fixture: ComponentFixture<EmpresaCredenciadaFormComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [EmpresaCredenciadaFormComponent],
      providers: [
        FormBuilder,
        Data,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EmpresaCredenciadaFormComponent);
