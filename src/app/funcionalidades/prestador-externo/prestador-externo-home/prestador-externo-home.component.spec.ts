...
import { PrestadorExternoHomeComponent } from './prestador-externo-home.component';

describe('PrestadorExternoHomeComponent', () => {
  let component: PrestadorExternoHomeComponent;
  let fixture: ComponentFixture<PrestadorExternoHomeComponent>;
  const messageServiceSpy = jasmine.createSpyObj('MessageService',['getDescription', 'fromResourceBundle']);
  const empresaPrestadorExternoServiceSpy = jasmine.createSpyObj('EmpresaPrestadorExternoService',['consultarEmpresaPorId', 'consultarFiliais','buscarEmpresas']);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [PrestadorExternoHomeComponent],
      providers: [
        FormBuilder,
        Data,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PrestadorExternoHomeComponent);
