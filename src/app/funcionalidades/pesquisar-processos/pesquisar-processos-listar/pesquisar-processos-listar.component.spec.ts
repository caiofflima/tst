...
import { PesquisarProcessosListarComponent } from './pesquisar-processos-listar.component';

describe('PesquisarProcessosListarComponent', () => {
  let component: PesquisarProcessosListarComponent;
  let fixture: ComponentFixture<PesquisarProcessosListarComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [PesquisarProcessosListarComponent],
      providers: [
        FormBuilder,
        Data,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PesquisarProcessosListarComponent);
