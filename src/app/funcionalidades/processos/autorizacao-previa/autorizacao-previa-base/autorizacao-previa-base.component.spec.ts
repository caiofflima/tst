...
import { AutorizacaoPreviaBaseComponent } from './autorizacao-previa-base.component';

describe('AutorizacaoPreviaBaseComponent', () => {
  let component: AutorizacaoPreviaBaseComponent;
  let fixture: ComponentFixture<AutorizacaoPreviaBaseComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [AutorizacaoPreviaBaseComponent,
        CampoVazioHifen
      ],
      providers: [
        FormBuilder,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AutorizacaoPreviaBaseComponent);
