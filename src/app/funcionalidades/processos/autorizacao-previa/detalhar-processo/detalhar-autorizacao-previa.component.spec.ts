...
import { DetalharAutorizacaoPreviaComponent } from './detalhar-autorizacao-previa.component';

describe('DetalharAutorizacaoPreviaComponent', () => {
  let component: DetalharAutorizacaoPreviaComponent;
  let fixture: ComponentFixture<DetalharAutorizacaoPreviaComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [DetalharAutorizacaoPreviaComponent,
        CampoVazioHifen
      ],
      providers: [
        FormBuilder,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DetalharAutorizacaoPreviaComponent);
