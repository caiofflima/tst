...
import {Pedido} from "../../../../../shared/models/entidades";
...
@Component({
    selector: 'asc-acompanhamento-apr',
    templateUrl: './acompanhamento-apr.component.html',
    styleUrls: ['./acompanhamento-apr.component.scss'],
    animations: [...fadeAnimation]
})

export class AcompanhamentoAprComponent extends AcompanhamentoCommon implements OnInit {
    ...
    get debugCardCondicao(): boolean {
        // console.log(
        //   '[DEBUG] possuiDocumentos:', this.possuiDocumentos,
        //   '| recebendoDocumentacaoTitular:', this.recebendoDocumentacaoTitular,
        //   '| isAguardandoDocumentoComplementar:', this.isAguardandoDocumentoComplementar,
        //   '| mostrarBordaVerdeObrigatorios:', this.mostrarBordaVerdeObrigatorios
        // );
        return this.possuiDocumentos && (!this.recebendoDocumentacaoTitular || (this.isAguardandoDocumentoComplementar && this.mostrarBordaVerdeObrigatorios));
      }
