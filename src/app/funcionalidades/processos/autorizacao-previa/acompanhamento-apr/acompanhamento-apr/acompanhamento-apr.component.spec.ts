...
import { AutorizacaoPreviaService, ComboService, DocumentoPedidoService, DocumentoService, EmpresaPrestadorExternoService, MessageService, PatologiaService, PrazoTratamentoService, PrestadorExternoService, ProcedimentoService, ProcessoService, SessaoService, SIASCFluxoService, SituacaoProcessoService, TipoBeneficiarioService, TipoProcessoService } from 'app/shared/services/services';
...
import { AcompanhamentoAprComponent } from './acompanhamento-apr.component';
...
describe('AcompanhamentoAprComponent', () => {
  let component: AcompanhamentoAprComponent;
  let fixture: ComponentFixture<AcompanhamentoAprComponent>;
  ...
  const procedimentoServiceSpy = jasmine.createSpyObj('ProcedimentoService',['get']);
  const medicamentoServiceSpy = jasmine.createSpyObj('MedicamentoService',['get']);
  const medicamentoPatologiaPedidoService = jasmine.createSpyObj('MedicamentoPatologiaPedidoService',['get']);
  const documentoPedidoService = jasmine.createSpyObj('DocumentoPedidoService',['get']);
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: DocumentoPedidoService, useValue: patologiaServiceSpy },
      ],
      schemas: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AcompanhamentoAprComponent);
