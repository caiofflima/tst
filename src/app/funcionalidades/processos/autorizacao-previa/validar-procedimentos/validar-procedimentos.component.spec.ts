...
import { ValidarProcedimentosComponent } from './validar-procedimentos.component';
import { EstruturaProcedimentoPipe } from 'app/shared/pipes/estrutura-procedimento.pipe';

describe('ValidarProcedimentosComponent', () => {
  let component: ValidarProcedimentosComponent;
  let fixture: ComponentFixture<ValidarProcedimentosComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ValidarProcedimentosComponent,
        CampoVazioHifen,
      ...
      providers: [
        ...
        { provide: SituacaoPedidoProcedimentoService, useValue: fileUploadServiceSpy },
      ],
      schemas: [
