...
import { AcompanhamentoPmdComponent } from './acompanhamento-pmd.component';
...
describe('AcompanhamentoPmdComponent', () => {
  let component: AcompanhamentoPmdComponent;
  let fixture: ComponentFixture<AcompanhamentoPmdComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [AcompanhamentoPmdComponent,
        CampoVazioHifen,
