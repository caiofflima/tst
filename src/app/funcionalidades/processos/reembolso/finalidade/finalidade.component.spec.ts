...
import { FinalidadeComponent } from './finalidade.component';

describe('FinalidadeComponent', () => {
  let component: FinalidadeComponent;
  let fixture: ComponentFixture<FinalidadeComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [FinalidadeComponent,
        CampoVazioHifen,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FinalidadeComponent);
