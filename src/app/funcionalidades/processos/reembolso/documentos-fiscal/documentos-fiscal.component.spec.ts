...
import { DocumentosFiscalComponent } from './documentos-fiscal.component';

describe('DocumentosFiscalComponent', () => {
  let component: DocumentosFiscalComponent;
  let fixture: ComponentFixture<DocumentosFiscalComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [DocumentosFiscalComponent,
        CampoVazioHifen,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DocumentosFiscalComponent);
