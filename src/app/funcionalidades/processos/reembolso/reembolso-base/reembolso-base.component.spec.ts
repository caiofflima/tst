...
import { ReembolsoBaseComponent } from './reembolso-base.component';

describe('ReembolsoBaseComponent', () => {
  let component: ReembolsoBaseComponent;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ReembolsoBaseComponent,
        CampoVazioHifen,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ReembolsoBaseComponent);
