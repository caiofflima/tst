...
import { PesquisarProcessosCredenciadoHomeComponent } from './pesquisar-processos-credenciado-home.component';

describe('PesquisarProcessosCredenciadoHomeComponent', () => {
  let component: PesquisarProcessosCredenciadoHomeComponent;
  let fixture: ComponentFixture<PesquisarProcessosCredenciadoHomeComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [PesquisarProcessosCredenciadoHomeComponent],
      providers: [
        FormBuilder,
        Data,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PesquisarProcessosCredenciadoHomeComponent);
