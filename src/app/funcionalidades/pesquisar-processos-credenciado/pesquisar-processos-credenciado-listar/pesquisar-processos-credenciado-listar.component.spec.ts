...
import { PesquisarProcessosCredenciadoListarComponent } from './pesquisar-processos-credenciado-listar.component';

describe('PesquisarProcessosCredenciadoListarComponent', () => {
  let component: PesquisarProcessosCredenciadoListarComponent;
  let fixture: ComponentFixture<PesquisarProcessosCredenciadoListarComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [PesquisarProcessosCredenciadoListarComponent],
      providers: [
        FormBuilder,
        Data,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PesquisarProcessosCredenciadoListarComponent);
