...
import { of } from 'rxjs';
import { ParametrizacaoDocumentosFromComponent } from './parametrizacao-documentos-from.component';
...
describe('ParametrizacaoDocumentosFromComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ParametrizacaoDocumentosFromComponent],
      providers: [
        FormBuilder,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ParametrizacaoDocumentosFromComponent);
