...
import { ParametrizacaoDocumentosHomeComponent } from './parametrizacao-documentos-home.component';


describe('ParametrizacaoDocumentosHomeComponent', () => {
  let component: ParametrizacaoDocumentosHomeComponent;
  let fixture: ComponentFixture<ParametrizacaoDocumentosHomeComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ParametrizacaoDocumentosHomeComponent],
      providers: [
        FormBuilder,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ParametrizacaoDocumentosHomeComponent);
