...
import { ExportacaoXLSService } from './exportacao-xls.service';
import { MessageService } from '../../../../components/messages/message.service';
import { HttpClient } from '@angular/common/http';
import { of } from 'rxjs';
import { PrestadorExternoService } from '../../prestador-externo.service';

describe('ExportacaoXLSService', () => {
  let service: ExportacaoXLSService;
  ...
  it('should call exportar and return an Observable', () => {
