...
@Component({
    selector: 'asc-select-beneficiario-renovacao',
    templateUrl: 'asc-select.component.html',
    encapsulation: ViewEncapsulation.None
})
export class AscSelectBeneficiarioRenovacaoComponent extends BaseSelectComponent<Beneficiario> implements OnInit {
    ...
    protected override carregarListOperator(): Observable<Beneficiario[]> {
        return this.beneficiarioService.consultarTodaFamiliaPorMatriculaRenovacao(this.matricula).pipe(
