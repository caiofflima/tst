...
@Component({
  selector: 'asc-select-medicamento-form',
  templateUrl: './asc-select-medicamento-form.component.html',
  styleUrls: ['./asc-select-medicamento-form.component.scss'],
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => AscSelectMedicamentoFormComponent),
    multi: true,
  }],
})
export class AscSelectMedicamentoFormComponent extends BaseSelectControlValueAcessor<Medicamento, AscSelectMedicamentoParam, TipoAcaoDePesquisa> {
