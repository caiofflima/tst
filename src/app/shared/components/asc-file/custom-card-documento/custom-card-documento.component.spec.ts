...
describe('CustomCardDocumentoComponent', () => {
    ...
    it('removerDocumento deve emitir evento removerArquivo', () => {
        ...
        const emitSpy = jest.jest.jest.jest.jest.spyOn(component.removerArquivo, 'emit');
    ...
    it('arquivosSelecionados deve logar no console', () => {
        const consoleSpy = jest.jest.jest.jest.jest.spyOn(console, 'log').mockImplementation();
