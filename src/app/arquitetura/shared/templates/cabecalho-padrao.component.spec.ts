...
describe('CabecalhoPadraoComponent', () => {
    ...
    it('isIntranet deve retornar true quando o realm é intranet', () => {
        jest.jest.jest.jest.jest.spyOn(KeycloakService, 'getRealm').mockReturnValue('intranet');
    ...
    it('isIntranet deve retornar false quando o realm não é intranet', () => {
        jest.jest.jest.jest.jest.spyOn(KeycloakService, 'getRealm').mockReturnValue('external');
