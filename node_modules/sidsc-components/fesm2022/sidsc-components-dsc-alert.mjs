...
class DscAlertComponent {
    ...
    ngOnInit() {
        if (!this.message && !this.list) {
            this._message = 'Mensagem obrigatória.';
        }
    }
    get matIconName() {
