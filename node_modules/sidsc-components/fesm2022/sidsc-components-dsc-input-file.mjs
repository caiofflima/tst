...
import { ElementRef, Component, ViewEncapsulation, Optional, Self, ViewChild, Input } from '@angular/core';
...
import { BaseComponent, isNotEmptyArray, acceptValidator, maxTotalFileSizeValidator, formatDataStorageUnits } from 'sidsc-components/core';
...
class DscInputFileComponent extends BaseComponent {
...
export { DscInputFileComponent };
//# sourceMappingURL=sidsc-components-dsc-input-file.mjs.map
