...
export declare class DscSidenavItemComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DscSidenavItemComponent, "dsc-sidenav-item", never, { "menu": { "alias": "menu"; "required": false; }; "depth": { "alias": "depth"; "required": false; }; "expanded": { "alias": "expanded"; "required": false; }; "selectedKey": { "alias": "selectedKey"; "required": false; }; }, { "onClick": "onClick"; "expandChange": "expandChange"; "selectedKeyChange": "selectedKeyChange"; }, never, never, true, never>;
}
