...
import { MatChipEditedEvent, MatChipEvent, MatChipGridChange, MatChipListboxChange, MatChipSelectionChange } from '@angular/material/chips';
...
export declare class DscChipComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DscChipComponent, "dsc-chip", never, { "chipItems": { "alias": "chipItems"; "required": false; }; "label": { "alias": "label"; "required": false; }; "placeholder": { "alias": "placeholder"; "required": false; }; "variant": { "alias": "variant"; "required": false; }; "shape": { "alias": "shape"; "required": false; }; "size": { "alias": "size"; "required": false; }; "multiple": { "alias": "multiple"; "required": false; }; "closeButton": { "alias": "closeButton"; "required": false; }; }, { "destroyed": "destroyed"; "removed": "removed"; "selectionChange": "selectionChange"; "edited": "edited"; "change": "change"; }, never, never, true, never>;
}
